...
//		TuboMoeda euro2 = new TuboMoeda(2);
        ...
        centimo50.removerMoeda(1); // Remove uma moeda de 0.50
        euro1.removerMoeda(1); // Remove uma moeda de 1.00
        ...
        Map<Double, Integer> moedasPorTipo = cofreMoedas.getMoedasPorTipo();
